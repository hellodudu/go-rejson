...
// GoRedisCluster implements ReJSON interface for Go-Redis/Redis Redis Cluster client
// Link: https://github.com/go-redis/redis
type GoRedisCluster struct {
	Conn *goredis.ClusterClient // import goredis "github.com/go-redis/redis/v7"
}
...
// 			 [NX | XX]
//
func (r *GoRedisCluster) JSONSet(key string, path string, obj interface{}, opts ...rjs.SetOption) (res interface{}, err error) { // nolint: lll
...
//			[path ...]
//
func (r *GoRedisCluster) JSONGet(key, path string, opts ...rjs.GetOption) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONMGet(path string, keys ...string) (res interface{}, err error) {
...
// 	JSON.DEL <key> <path>
//
func (r *GoRedisCluster) JSONDel(key string, path string) (res interface{}, err error) {
...
// 	JSON.TYPE <key> [path]
//
func (r *GoRedisCluster) JSONType(key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONNumIncrBy(key, path string, number int) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONNumMultBy(key, path string, number int) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONStrAppend(key, path, jsonstring string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONStrLen(key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONArrAppend(key, path string, values ...interface{}) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONArrLen(key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONArrPop(key, path string, index int) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONArrIndex(key, path string, jsonValue interface{}, optionalRange ...int) (res interface{}, err error) { // nolint: lll
...
//
func (r *GoRedisCluster) JSONArrTrim(key, path string, start, end int) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONArrInsert(key, path string, index int, values ...interface{}) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONObjKeys(key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONObjLen(key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONDebug(subcommand rjs.DebugSubCommand, key, path string) (res interface{}, err error) {
...
//
func (r *GoRedisCluster) JSONForget(key, path string) (res interface{}, err error) {
...
// 	JSON.RESP <key> [path]
//
func (r *GoRedisCluster) JSONResp(key, path string) (res interface{}, err error) {
